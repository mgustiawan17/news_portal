        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom shadow-sm">
            <div class="container">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link text-capitalize" href="<?= Url::to(['news/category','category'=>$cat]) ?>"><?= $cat ?></a></li>
                    <?php endforeach; ?>
                </ul>
                <form class="d-flex" method="get" action="<?= Url::to(['news/search']) ?>">
